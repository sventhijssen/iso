...
class CrossbarWriter:
    ...
    def __init__(self, crossbar: Crossbar, file_name):
    ...
    def write(self):
        with open(self.file_name, 'w') as f:
            ...
            if isinstance(self.crossbar, SelectorCrossbar):
                f.write(".type {}\n".format("selector"))
            else:
                f.write(".type {}\n".format("memristor"))
            ...
            if isinstance(self.crossbar, SelectorCrossbar):
                for i in range(len(self.crossbar.selectorlines)):
                    literal = self.crossbar.selectorlines[i]
